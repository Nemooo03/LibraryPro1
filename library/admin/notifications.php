        ...
        <?php else: ?>
            <?php foreach ($notifs as $n): ?>
                <div class="d-flex align-items-start gap-3 px-4 py-3 border-bottom">
                    <?php
                    $icons = ['success'=>'check-circle-fill text-success','danger'=>'x-circle-fill text-danger','warning'=>'exclamation-triangle-fill text-warning','info'=>'info-circle-fill text-primary'];
